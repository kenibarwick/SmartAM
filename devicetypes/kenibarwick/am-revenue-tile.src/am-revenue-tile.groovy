 ...
 *  2019-01-31 Version 0.0.10 PGA not GPA
*/
    ...
    tiles {
        ...
        tiles(scale: 2) {
            ...
            main("revenuePerDayMain")
            	details(["profitPerDay", "profitPerMonth", "powerUsage", "revenuePerDay", "revenuePerMonth", "refresh", "runningCount", "totalCount", "gpuCount", "asicCount", "pgaCount", "cpuCount", "exchangeRate", "info", "algorithmList"])
                }
    }
 	preferences {
        ...
        input name: "AM_pga_count", type: "number", title: "Count of PGAs", description: "Enter ammount of PGAs", required: true     
...
def responseHandlerMethod(response, data) {
    ...
    sendEvent(name: "pgaCount", value: pgaCount)
